...
if __name__ == '__main__':
    ...
    for i in range(training_cycles_per_task):
        ...
        for k in range(episode_length):
            ...
            for step in range(training_steps_per_task):
                ...
                for t in range(steps_taken):
                    ...
                    for _ in range(future_k):
                        ...
                        #hingsight replay-stragety future, 
            ...
            write.add_scalar("success_graph",score,k)
            
        total_train_score.append(total_score)   
        write.add_scalar("training_cycle_total_score",total_score,i)
